...
$databases['default']['shared'] = array(
  'driver' =>'mysql',
  'database' => 'ts_shared_drupal',
  'username' => 'drupaladmin',
  'password' => 'drup@1p@55',
  'host' => 'drupaldb',
  'port' => '3307',
...
/**
 * Sets the server address used to retrieve simulcast schedule data in CSV format
 */

define('SIMULCAST_DATA_SOURCE', URL_UNSECURE_BASE.'/php/getSchedule.php?site=twin');

/**
 * Set affiliate id
 */

define('AFFILIATE_ID', 2800);

require_once 'AffiliateCookies.php';
AffiliateCookies::setSAIDCookie(AFFILIATE_ID);
require_once 'AdwSite'.AFFILIATE_ID.'.php';

/** Check URL */
require_once 'Cdi/Html.php';
if (Cdi_Html::xssUrlCheck('//' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'])) {
    header('Location: //' . AdwSite::DOMAIN . '/');
    exit;
}
...
$conf = array(
    ...
    'memcache_key_prefix' => 'ts_',
    'memcache_servers' => array(
        'memcache01:11211' => 'default',
    ),
    'memcache_bins' => array(
        'cache' => 'default',
        'cache_block'  => 'default',
...
*/
/**
* Sets the file extension to use for style sheets (.css or .less)
*/
define('STYLESHEET_TYPE', '.css');

/*
############################ Environment configuration ###############################
*/
include_once('/nas/whiteLabel/includes/envconfig.inc');
$environment = array_merge($env[0], $env[AFFILIATE_ID]);
$conf += $environment;
...
$conf['fast_404_HTML_error_page'] = '/nas/whiteLabel/webroot/error.html';
